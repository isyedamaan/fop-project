...
public class Main {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            "(2) : Number of jobs Finished Successfully\n"+
            "(3) : Number of jobs not Finished Correctly\n"+        
            "(4) : Number of jobs by partition\n"+
            "(5) : Errors\n"+
            "(6) : Average time of jobs\n"+
            "(7) : Number of jobs killed\n"+
            "(8) : Number of jobs whose time limit was exhausted\n"+
            ...
            switch (job) {
                ...
                case 2:
                    ...
                    switch (subJob) {
                        case 1: 
                        {
                            int[] graphData = new int[months.length-1];
                            for(int i = 0; i<months.length-1; i++){
                                graphData[i] = logData.getJobsFinishedSuccessfully(months[i],months[i+1]);
                            }
                            GUIPanel g1 = new GUIPanel("Total Jobs Completed Each Month",graphData,monthNames);
                            String tableData[][] = new String[months.length][2];
                            tableData[7][0] = "TOTAL";
                            tableData[7][1] = ""+logData.getJobsFinishedSuccessfully(months[0],months[7]);
                            for(int i = 0; i < months.length-1; i++){
                                tableData[i][0] = monthNames[i];
                                tableData[i][1] = ""+graphData[i];
                            }
                        ...
                        case 2:
                        {
                            int[] graphData = new int[weeks.length-1];
                            for(int i = 0; i<weeks.length-1; i++){
                                graphData[i] = logData.getJobsFinishedSuccessfully(weeks[i],weeks[i+1]);
                            }
                            GUIPanel g1 = new GUIPanel("Total Jobs Completed Each Week",graphData,weekCount);
                            String tableData[][] = new String[weeks.length][2];
                            tableData[29][0] = "TOTAL";
                            tableData[29][1] = ""+logData.getJobsFinishedSuccessfully(weeks[0],weeks[29]);
                            for(int i = 0; i < weeks.length-1; i++){
                                tableData[i][0] = weekCount[i];
                                tableData[i][1] = ""+graphData[i];
                            }
                        ...
                        case 3:
                            ...
                            System.out.print("Enter End TIme [yyyy-MM-dd HH:mm:ss.SSS] : ");
                            String endTime = sc.nextLine();
                            System.out.println("Number of jobs FinishedSuccessfully in the given time: "+logData.getJobsFinishedSuccessfully(startTime,endTime));
                            System.out.println("+---------------------------------------------------------------+");
                            break;
                        case 0:
                            break OUTER;
                ...
                case 3:
                    //jobs not successfull
                    System.out.println("+------------------------------------------------------------+\n"+
                                        "Data for Jobs Not Finished correctly(Exit status != 0) : \n"+
                                        "(1) : Whole Data [graph & table] - divided by months\n"+
                                        "(2) : Whole Data [graph & table] - divided by weeks\n"+
                                        "(3) : Custom time period\n"+
                                        "(0) : Exit\n"+
                    ...
                    switch (subJob) {
                        case 1: 
                        {
                            int[] graphData = new int[months.length-1];
                            for(int i = 0; i<months.length-1; i++){
                                graphData[i] = logData.getJobsNotFinishedCorrectly(months[i],months[i+1]);
                            }
                            GUIPanel g1 = new GUIPanel("Total Jobs not finished correctly Each Month",graphData,monthNames);
                            String tableData[][] = new String[months.length][2];
                            tableData[7][0] = "TOTAL";
                            tableData[7][1] = ""+logData.getJobsNotFinishedCorrectly(months[0],months[7]);
                            for(int i = 0; i < months.length-1; i++){
                                tableData[i][0] = monthNames[i];
                                tableData[i][1] = ""+graphData[i];
                            }
                            String[] columns = {"Month","No. of jobs"};
                            g1.setTable(tableData, columns);
                            g1.makeGraph(g1);
                            break;
                        }
                        case 2:
                        {
                            int[] graphData = new int[weeks.length-1];
                            for(int i = 0; i<weeks.length-1; i++){
                                graphData[i] = logData.getJobsNotFinishedCorrectly(weeks[i],weeks[i+1]);
                            }
                            GUIPanel g1 = new GUIPanel("Total Jobs not finished correctly Each Week",graphData,weekCount);
                            String tableData[][] = new String[weeks.length][2];
                            tableData[29][0] = "TOTAL";
                            tableData[29][1] = ""+logData.getJobsNotFinishedCorrectly(weeks[0],weeks[29]);
                            for(int i = 0; i < weeks.length-1; i++){
                                tableData[i][0] = weekCount[i];
                                tableData[i][1] = ""+graphData[i];
                            }
                            String[] columns = {"Week","No. of jobs"};
                            g1.setTable(tableData, columns);
                            g1.makeGraph(g1);
                            break;
                        }
                        case 3:
                            ...
                            System.out.print("Enter End TIme [yyyy-MM-dd HH:mm:ss.SSS] : ");
                            String endTime = sc.nextLine();
                            System.out.println("Number of jobs not finished correctly in the given time: "+logData.getJobsNotFinishedCorrectly(startTime,endTime));
                            System.out.println("+---------------------------------------------------------------+");
                            break;
                        case 0:
                            break OUTER;
                ...
                case 4:
                    ...
                    case 1:
                        ...
                        for(int i = 0; i<6; i++){
                            graphData[i] = logData.getJobsByPartitions(months[0],months[7],partitions[i]);
                        }
                    ...
                    case 8:
                        ...
                        System.out.println("Number of jobs FinishedSuccessfully in the given time: "+logData.getJobsByPartitions(startTime,endTime,partition));
                        System.out.println("+---------------------------------------------------------------+");
                        break;
                    case 0:
                        break OUTER;
